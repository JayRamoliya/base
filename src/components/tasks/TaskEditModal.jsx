...
import { Calendar as CalendarIcon, Upload, User as UserIcon, Trash2 } from "lucide-react";
...
export default function TaskEditModal({ isOpen, onClose, onSave, onDelete, task }) {

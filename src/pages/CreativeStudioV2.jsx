...
export default function CreativeStudioV2() {
...
- ${toneInstruction}
- ${formatInstruction}
- NEVER include any links, URLs, website addresses, or call-to-actions with links
- Do NOT include phrases like "link in bio", "visit our website", or any reference to external sources
...
- NO LINKS OR URLS ANYWHERE IN THE CONTENT
      ...
      const response = await InvokeLLM({
        ...
        response_json_schema: {
          ...
          properties: {
            content: {
              type: "string",
              description: "The full text content for the social media post with powerful psychological hooks, no links allowed."
            },
            hashtags: {
              type: "array",
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-purple-600 text-white rounded flex items-center justify-center">
          ...
          {/* Tabs */}
          <div className="flex space-x-1 bg-gray-100 p-1 rounded w-fit">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`flex items-center gap-2 px-4 py-2.5 rounded font-medium transition-all duration-200 ${
                  activeTab === tab.id
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-white border-0 shadow-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                ...
                className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 rounded"
              >
          ...
          <Card className="bg-white border-0 shadow-sm">
            ...
            <CardContent>
              {generationError && (
                <div className="h-[520px] bg-red-50 border border-red-200 rounded flex items-center justify-center text-red-700">
              ...
              {!generationError && (activeTab === "image" ? (
                generatedImagePrompt ? (
                  <div className="space-y-4">
                    <div className="bg-gray-50 rounded p-4 border h-[520px] overflow-y-auto">
                  ...
                  <div className="h-[520px] bg-gray-100 rounded flex items-center justify-center text-gray-500">
